...
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		...
		<div class="modal fade" id="add-book-modal" tabindex="-1"
			role="dialog" aria-labelledby="add-book-modal-label"
			aria-hidden="true">
					...
					<form name="add_form_book">
							...
							<div class="container-fluid">
								<div class="row">
									<div id="add-left" class="col-sm-4 col-xs-12">
										<img name="thumbnail" class="img-responsive"
											style="margin: auto;"
									...
									<div id="add-right" class="col-sm-8 col-xs-12">
										<div class="row">
											<ul class="list-unstyled col-12">
												...
												<li><input name="publisher" class="col-xs-12 col-sm-12"
													type="text" disabled="disabled" placeholder="출판사" /></li>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"
								onclick="addBookData(window.add_form_book)">등록하기</button>
		...
		<!-- 도서수정/삭제 모달 -->
		<div class="modal fade" id="update-book-modal" tabindex="-1"
			role="dialog" aria-labelledby="update-book-modal-label"
			aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<form name="update_form_book">
						<div class="modal-header" id="modal-header">도서 수정/삭제</div>
						<div class="modal-body">
							<div class="container-fluid">
								<div class="row">
									<div id="update-left" class="col-sm-4 col-xs-12">
										<img name="thumbnail" class="img-responsive"
											style="margin: auto;"
											src="/comic/resources/img/book/unknown_cover.png" />
									</div>
									<div id="update-right" class="col-sm-8 col-xs-12">
										<div class="row">
											<ul class="list-unstyled col-12">
												<li><input name="title" class="col-xs-12 col-sm-12"
													type="text" disabled="disabled" placeholder="책 제목" /></li>
												...
												<li><select name="status" class="col-xs-12 col-sm-12"
													disabled="disabled" placeholder="상태">
														<option value="">==상태==</option>
														<option value="S">입고</option>
														<option value="L">분실</option>
												</select></li>
												<li><input id="isbn" name="isbn"
													class="col-xs-12 col-sm-12" type="number"
													placeholder="isbn"
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-danger" name="delbtn"
								onclick="deleteItem(window.update_form_book.isbn.value)">삭제</button>
							<button type="button" class="btn btn-primary"
								onclick="updateBookData(window.update_form_book)">수정하기</button>
							<button type="button" class="btn btn-default"
								data-dismiss="modal">닫기</button>
						</div>
					</form>
