				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<p class="text-center text-muted">
							...
							<br><a href="#" data-dismiss="modal" data-toggle="modal" data-target="#findid-modal">아이디찾기</a>
		...
		<nav class="nav-menuzord nav-menuzord-transparent navbar-sticky" id="navbackground">
			<div class="container clearfix">
				<div id="menuzord" class="menuzord menuzord-responsive">
					...
					<a href="/comic/index.do" class="menuzord-brand"> 
					<img alt="logo" src="/comic/resources/img/logo-blue.png" style="width:180px;height:70px;border: 2 solid white;">
					<!-- <svg
