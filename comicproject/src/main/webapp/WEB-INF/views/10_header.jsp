					...
					<ul class="menu">
						<c:choose>
							<c:when test="${fn:contains(isyn,'Y') and type eq 'C'}">
								<li><span style="color: white;">${name}님 환영홥니다.</span></li>
							...
							<c:when test="${fn:contains(isyn,'Y') and type eq 'S'}">
								<div class="float-right btn-wrapper" style="margin-top: 40px;">
									<span style="color: white" class="navlogininfo">${name}님
										환영합니다. || </span> 
									<span style="color: white" class="navlogininfo">현재
										잔여 포인트 : ${point } || 
									</span> 
									<a href="/comic/myInfo.do"><span
							...
							<c:otherwise>
								...
								<li><a href="#" data-toggle="modal"
									data-target="#reg-modal">회원가입</a></li>
			...
			<div class="container">
				<div class="navbar-header">
					...
					<div class="navbar-buttons">
						...
						<a class="btn btn-default navbar-toggle"
							href="/comic/order/cart.do"> <i class="fa fa-shopping-cart"></i>
							<span class="hidden-xs">최근 확인 도서</span>
						</a>
					</div>
				</div>
				<!--/.navbar-header -->
										...
										<div class="row">
											<div class="col-sm-3">
												...
												<ul>
													...
													<li><a href="category.html">Category - sidebar
															left</a></li>
				...
				<div class="navbar-buttons">
					...
					<div class="navbar-collapse collapse right" id="basket-overview">
						<a href="/comic/order/cart.do" class="btn btn-primary navbar-btn"><i
					...
					<div class="navbar-collapse collapse right" id="search-not-mobile">
						...
						<button type="button" class="btn navbar-btn btn-primary"
							...
							<span class="sr-only">Toggle search</span> <i
								class="fa fa-search"></i> <span class="hidden-sm">도서 검색</span>
						</button>
					</div>
