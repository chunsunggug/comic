...
<footer class="footer-dark"
	style="background-image: url(/comic/resources/img/background/bg-footer.jpg)">
		...
		<div class="row">
			<div class="col-sm-7 col-xs-12">
              ...
              <path class="fill-primay"
				...
				<p class="text-white pt-1 pb-3">Lorem ipsum dolor sit amet,
					consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
					labore et dolore magna aliqua. Ut enim ad minim veniam, quis
					nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
					consequat. Duis aute irure dolor</p>
				<ul class="list-unstyled text-white">
					<li class="mb-3"><i class="fa fa-phone mr-3"
						aria-hidden="true"></i> <a class="text-white"
						href="tel:[88] 657 524 332">[88] 657 524 332</a></li>
					<li class="mb-3"><i class="fa fa-envelope mr-3"
						aria-hidden="true"></i> <a class="text-white"
						href="mailto:info@listy.com">info@listy.com</a></li>
				</ul>
			</div>
			...
			<div class="col-sm-3 col-xs-12">
				...
				<ul class="list-unstyled list-gray">
					...
					<li class="mb-3"><a href="edit-listings.html">Edit Listing</a>
					</li>
				</ul>
			</div>
			...
			<div class="col-sm-2 col-xs-12">
				...
				<ul class="list-unstyled list-gray">
					<li class="mb-3"><a href="contact-us.html">Contact Us</a></li>
					<li class="mb-3"><a href="terms-of-services.html">Terms
							and Conditions</a></li>
					<li class="mb-3"><a href="how-it-works.html">How It Works</a>
					</li>
					<li class="mb-3"><a href="payment-process.html">Payment</a></li>
					<li class="mb-3"><a href="pricing-table.html">Pricing</a></li>
				</ul>
			</div>
			...
			<div class="col-sm-5 col-xs-12 d-flex align-items-center">
				<div class="ml-md-auto mx-auto mx-md-0 mt-3 mb-5 my-md-0">
					<a
						...
						href="#facebook"> <i class="fa fa-facebook" aria-hidden="true"></i>
					</a> <a
						class="icon-sm icon-default icon-border hover-bg-primary rounded-circle ml-2"
						href="#twitter"> <i class="fa fa-twitter" aria-hidden="true"></i>
					</a> <a
						class="icon-sm icon-default icon-border hover-bg-primary rounded-circle ml-2"
						href="#pinterest"> <i class="fa fa-pinterest-p"
						aria-hidden="true"></i>
					</a> <a
						class="icon-sm icon-default icon-border hover-bg-primary rounded-circle ml-2"
						href="#linkedin"> <i class="fa fa-linkedin" aria-hidden="true"></i>
					</a>
				</div>
			</div>
		</div>
...
<script
	src="/comic/resources/plugins/daterangepicker/daterangepicker.js"></script>
<script
	src="/comic/resources/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
<script
	src="/comic/resources/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
...
<script
	src="/comic/resources/plugins/imagesloaded/imagesloaded.pkgd.min.js"></script>
<script
