...
public interface IStoreBookService {
	...
	public boolean delete(int sidx, String isbn);				// 책 삭제
	public boolean delete(int sbidx);							// 기본키로 책 삭제
	...
	public StoreBookDTO getBook(int sidx, String isbn);		// 점포의 해당 책들 데이터
